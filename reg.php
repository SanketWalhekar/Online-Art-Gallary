      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card shadow-2-strong" style="border-radius: 1rem;">
          ...
          <form action="signup_script.php" method="post">
            ...
            <div class="form-outline mb-4">
              <input type="email" id="typeEmailX-2" name="eMail" class="form-control form-control-lg" placeholder="Your Email"  required/>
            ...
            <button class="btn btn-lg btn-block"   type="submit" name="submit"  style="background-color: #E0B0FF">Sign In</button>
            <br>
            <br>
